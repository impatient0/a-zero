...
*   [ ] **v0.3:** AI-Enabled Backtesting Framework
    ...
    *   [x] **`a0-backtester-cli` & Core Engine:** Enhance the backtester to load and use the pre-processed sentiment data, making it available to strategies via the `TradingContext`.
